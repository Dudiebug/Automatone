...
public class MovementAscend extends Movement {
    ...
    public MovementState updateState(MovementState state) {
        ...
        state.setInput(Input.SNEAK, baritone.getSettings().allowWalkOnMagmaBlocks.value && jumpingOnto.is(Blocks.MAGMA_BLOCK));
        ...
        if (baritone.getSettings().assumeStep.value || ctx.playerFeet().equals(src.above())) {
