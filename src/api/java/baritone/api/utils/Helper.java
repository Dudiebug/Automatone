...
/**
 * An ease-of-access interface to provide Baritone logging mechanisms and the
 * Baritone message prefix. Logging is dispatched through the configured
 * callbacks so the same implementation is safe on a dedicated server.
 *
 * @author Brady
 * @since 8/1/2018
 */
